// Simple procedural web audio / iOS sound effect synthesizer
// Generates ATC radar beeps, landing chimes, warning sirens, and crash explosions without external mp3s
